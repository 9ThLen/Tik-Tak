...
| Сильна доля та розмір | ⚙️ Евристика працює; ML-модель попереду |
...
Офлайн-аналіз визначає розмір (4/4, 3/4, 2/4, 6/8) і те, з якої долі
починається такт, після чого клік акцентує першу долю сам. Це поки що
евристика на трьох ознаках, а не модель: вона працює на матеріалі з виразною
бочкою або зміною гармонії й чесно каже, коли не впевнена. ML-моделі
(Beat This! офлайн, BeatNet онлайн) — наступний крок, і вимірюваний базовий
рівень для них уже є.
...
фази та розгортає поріг за покриттям і частотою помилкових акцентів. Бракує
самих записів: 30–50 розмічених треків, і поріг перестане бути заглушкою.
Формат розмітки й що саме вимірюється — у `research/eval/README.md`.
