...
void printUsage() {
    std::printf(
        ...
        "\n"
        "`tap` plays the music and nothing else, and records when you press a\n"
        "key. It cannot measure accuracy — people tap early and unevenly — but it\n"
        "sees the three failures a corpus average hides: a grid on the off-beat,\n"
        "a grid at half or double the pulse you hear, and a grid that drifts.\n"
        "\n"
        "Listen options:\n"
